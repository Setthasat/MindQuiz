...
class AuthAPI {
    constructor() {
        ...
        this.getUserProfile = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const user = yield user_model_1.default.findOne({ userId }).select('-password');
                if (!user) {
                    baseResponseInst.setValue(404, "User not found", null);
                    return res.status(404).json(baseResponseInst.buildResponse());
                }
        ...
        this.updateUserProfile = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const user = yield user_model_1.default.findOneAndUpdate({ userId }, { username }, { new: true }).select('-password');
                if (!user) {
                    baseResponseInst.setValue(404, "User not found", null);
                    return res.status(404).json(baseResponseInst.buildResponse());
                }
